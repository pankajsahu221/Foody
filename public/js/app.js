...
function placeOrder(formData) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/orders/add", formData).then(function (res) {
...
function updateCart(food) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", food).then(function (res) {
    //   console.log(res);
    cartCounter.innerText = res.data.totalQty; //   to show a popup
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(); // dynamically status update
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false; // set the time based on the order's last updated activity
...
socket.on("orderUpdated", function (data) {
  ...
  updateStatus(updatedOrder); //   to show a popup

  new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
    text: "Order ".concat(data.status),
    type: "success",
    timeout: 1000,
    progressBar: false
  }).show();
});
updateStatus(order); // for order

(0,_stripe__WEBPACK_IMPORTED_MODULE_3__.initStripe)(); // searchpage starts
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var stripe, card, moundWidget, paymentType, paymentForm;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            moundWidget = function _moundWidget() {
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("pk_test_51HUVu5BlQOo2nKL9aKLnsYYd1jfpz1hxGKG73vrY0EWoHrGNYK5tayMJ3onQkoUMfHHZJiRIPRsf1HsIkrZZvHR4006QsMpEH7");
          ...
          case 3:
            ...
            if (paymentForm) {
              paymentForm.addEventListener("submit", function (e) {
                ...
                if (!card) {
                  (0,_apiService__WEBPACK_IMPORTED_MODULE_3__.placeOrder)(formData);
                  return;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoody"] = self["webpackChunkfoody"] || [];
